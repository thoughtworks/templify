...
public class YamlConfigReaderV2 {
    ...
    public PluginConfigV2 read(String configFilePath) throws IOException {
        return this.<PluginConfigV2>mapYamlToType(configFilePath, PluginConfigV2.class);
    }
}
